...
class _QrScannerScreenState extends State<QrScannerScreen> {
  ...
  Future<void> _processScanneddata(String? data) async {
    ...
    showModalBottomSheet(
      ...
      isDismissible: false,   // not close on outside-tap
      enableDrag:    false,   // not close with drag
      builder:
  ...
  final contact = contacts.Contact()..name.first= name ?? ''
  ...
  Widget build(BuildContext context) {
    if(!hasPermission){      //if permission is not granted
      return Scaffold(
